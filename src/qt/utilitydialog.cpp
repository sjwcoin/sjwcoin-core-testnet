    ...
    ui(new Ui::AboutDialog)
{
	...
	tr("Copyright") + QString(" &copy; 2013-%1 ").arg(COPYRIGHT_YEAR) + tr("The SJWcoin developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("SJWcoin Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  sjwcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("SJWcoin Core is shutting down...") + "<br /><br />" +
