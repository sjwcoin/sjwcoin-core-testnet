...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MSJW);
    unitlist.append(kSJW);
    unitlist.append(SJW);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MSJW: return QString("MSJW");
    case kSJW: return QString("kSJW");
    case SJW: return QString("SJW");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MSJW: return QString("Mega-SJWcoin (1,000,000 SJW)");
    case kSJW: return QString("Kilo-SJWcoin (1000 SJW)");
    case SJW: return QString("SJWcoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MSJW: return Q_INT64_C(100000000000000);
    case kSJW: return Q_INT64_C(100000000000);
    case SJW:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MSJW: return Q_INT64_C(900000);
    case kSJW: return Q_INT64_C(900000000);
    case SJW:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MSJW: return 6;  // 900,000 (# digits, without commas)
    case kSJW: return 9;  // 900,000,000
    case SJW:  return 12; // 900,000,000,000
