...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1434661056;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 1644661;
        ...
        std::vector<unsigned char> sk  = list_of(223); //128+PUBKEY_ADDRESS(95)
...
public:
    CRegTestParams() {
        ...
        bnProofOfWorkLimit = CBigNum(~uint256(0) >> 20); //was1 now 20
        genesis.nTime = 1434661056;
        ...
        nDefaultPort = 18444;
        strDataDir = "regtest";
		//printf("genesis.regtest.GetHash(): %s\n", hash.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x739563e4d397c0bd7a27efd4ada03ab99e28b1ededd30dd9716b238712d7320f"));
