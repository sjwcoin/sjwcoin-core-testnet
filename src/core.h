...
// original tacocoin chain ID = 0x0018
// SJWCoin aux chain ID = 0x0037 (55) just not yet, whoops, sorry taco
static const int AUXPOW_CHAIN_ID = 0x0018;
static const int AUXPOW_START_MAINNET = 35000;
static const int AUXPOW_START_TESTNET = 10;

/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 500000000 * COIN; // SJWcoin: maximum of 50M coins, max transaction 500,000,000
...
public:
    ...
    {
        // SJWcoin: IsDust() detection disabled, allows any valid dust to be relayed.
