Gitian building // sjwcoin has no procedure in place for gitian building
================
...
Get the [Debian 7.4 net installer](http://ftp.sunet.se/pub/Linux/distributions/debian-cd/7.4.0/amd64/iso-cd/debian-7.4.0-amd64-netinst.iso).
...
```bash
cd gitian-builder
nano bin/make-base-vm
```

locate the line: "mkfs.ext4 -F $OUT-lxc"
prepend sudo to it: "sudo mkfs.ext4 -F $OUT-lxc"
then carry on
